...
Questo è il passaggio più importante. Prima di inviare il tuo lavoro su GitHub, devi scaricare le ultime modifiche di develop e integrarle nel tuo branch. In questo modo sei tu a risolvere eventuali conflitti in locale, senza aspettare il team leader.
...
Vai su GitHub.com nella repo del progetto

Clicca su “Compare & pull request” (appare in automatico dopo il push)

Verifica che sia impostato: base → develop, compare → il tuo branch

Scrivi una descrizione di cosa hai fatto

Aggiungi il team leader come reviewer
...
GitHub Desktop non supporta git stash graficamente — usa il terminale per questo caso.
...
| `feature/results_alessandro` | Results page | @alessandro01nappa |
